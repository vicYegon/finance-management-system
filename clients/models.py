...
phone_regex = RegexValidator(
    regex=r'^\+?1?\d{9,15}$',
    message='Phone number invalid. Should start with example: +254'
)
...
class Client(models.Model):
    ...
    nationality = models.CharField(max_length=200, default='Kenyan')
    ...
    residential_county = models.CharField(max_length=200, null=True)
    ...
    county_of_issue = models.CharField(max_length=150)
    ...
    next_of_kin_contact = models.CharField(
        validators=[phone_regex], max_length=15, null=True)
    relation_with_next_of_kin = models.CharField(max_length=200, null=True)
    next_of_kin_residence = models.CharField(max_length=200, null=True)
    next_of_kin_region = models.CharField(max_length=200, null=True)
    ...
    relationship_with_emergency_contact = models.CharField(
